...
# tiny-editable-grid
 ...
 [![Support me on Patreon][badge_patreon]][patreon] [![Buy me a book][badge_amazon]][amazon] [![PayPal][badge_paypal_donate]][paypal-donations] [![Ask me anything](https://img.shields.io/badge/ask%20me-anything-1abc9c.svg)](https://github.com/IonicaBizau/ama) [![Version](https://img.shields.io/npm/v/tiny-editable-grid.svg)](https://www.npmjs.com/package/tiny-editable-grid) [![Downloads](https://img.shields.io/npm/dt/tiny-editable-grid.svg)](https://www.npmjs.com/package/tiny-editable-grid) [![Get help on Codementor](https://cdn.codementor.io/badges/get_help_github.svg)](https://www.codementor.io/@johnnyb?utm_source=github&utm_medium=button&utm_term=johnnyb&utm_campaign=github)
...
[![tiny-editable-grid](https://i.imgur.com/VJ00Vu1.png)](#)
...
```sh
# Using npm
npm install --save tiny-editable-grid

# Using yarn
yarn add tiny-editable-grid
```
...
```js
const tinyEditableGrid = require("tiny-editable-grid");
